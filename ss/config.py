...
parser.add_argument('--num_hidden', type=int, default=100, help='number of hidden layers')
...
parser.add_argument('--steps_per_checkpoint', type=int, default=16, help='steps per checkpoint')
parser.add_argument('--checkpoint_num', type=int, default=0, help='checkpoint Number')
parser.add_argument('--checkpoints_dirpath', type=str, default='model/checkpoints', help='path for check points')
...
parser.add_argument('--log_dir', type=str, default='logs', help='testing data directory path')
parser.add_argument('--out_dir', type=str, default='out', help='testing data directory path')
parser.add_argument('--load_from_checkpoint', type=bool, default=False, help='load from checkpoint')
parser.add_argument('--restore_rbm', type=bool, default=False, help='Whether to restore the RBM weights or not.')
